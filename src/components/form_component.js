        ...
        <form onSubmit={handleSubmit} className='container my-3'>
            <div className='row justify-content-between g-1'>
                <div class="col-xl-5 form-floating mb-3 m-xl-0">
                    <input type="number" class="form-control" id="newCredit" placeholder="New Credit" onChange={(e) => setCredit(e.target.value)}></input>
                    <label htmlFor="newCredit">New Credit</label>
                </div>

                <div class="col-xl-5 form-floating mb-3 m-xl-0">
                    <input type="number" class="form-control" id="retakeCredit" placeholder="Retake Credit" onChange={(e) => setRetake(e.target.value)}></input>
                ...
                <div className='mt-3 d-xl-flex gap box-border col-xl-5 justify-content-between'>
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="waiver" id="wv100" value="1" onChange={(e) => setWaiver(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="wv100">100</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="waiver" id="wv50" value="0.5" onChange={(e) => setWaiver(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="wv50">50</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="waiver" id="wv25" value="0.25" onChange={(e) => setWaiver(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="wv25">25</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="waiver" id="wv0" value="0" onChange={(e) => setWaiver(e.target.value)}></input>
                ...
                <div className='mt-3 d-xl-flex gap box-border col-xl-5 justify-content-between'>
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="scholarship" id="sc100" value="1" onChange={(e) => setScholarship(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="sc100">100</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="scholarship" id="sc50" value="0.5" onChange={(e) => setScholarship(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="sc50">50</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="scholarship" id="sc25" value="0.25" onChange={(e) => setScholarship(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="sc25">25</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="scholarship" id="sc0" value="0" onChange={(e) => setScholarship(e.target.value)}></input>
                ...
                <div className='mt-3 d-xl-flex gap box-border col-xl-5 justify-content-between m-auto'>
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="late_fine" id="yes" value="true" onChange={(e) => setLateFine(e.target.value)}></input>
                            <label class="form-check-label" htmlFor="yes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="late_fine" id="no" value="false" onChange={(e) => setLateFine(e.target.value)}></input>
